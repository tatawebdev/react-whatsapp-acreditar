...
export default function ListaContatos() {
  ...
  const handleClick = (user) => {
    ...
    const sessionEnd = new Date(user.session_end);

    user.isActive = sessionEnd > currentTime;
      ...
      <div className="overflow-x-hidden overflow-y-auto flex-grow scroller h-10">
        {conversations.map((user) => {
          const StatusComponent =
            statusComponents[user.last_message_status] || None;
                ...
                <div className="flex flex-col w-80">
                  ...
                  <div className="flex text-[#aebac1] space-x-2">
                    <span className="text-sm font-normal text-gray-500 dark:text-gray-400">
                      <StatusComponent  height="100%" width="18" />
                    </span>
