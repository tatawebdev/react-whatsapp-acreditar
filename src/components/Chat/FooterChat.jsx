...
const SendButton = ({ buttonVoice, setButtonVoice, isRecording, setIsRecording }) => {
...
const FooterChat = () => {
  const [buttonVoice, setButtonVoice] = useState(true);
  ...
  return (
    <div className="flex flex-none space-x-2 items-center bg-[#202c33] px-6 py-4">
