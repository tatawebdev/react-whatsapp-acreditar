...
import { post, postImage } from './api';


export const sendMessageText = async (content, from, contact_name, unique_identifier) => {
  try {
    const response = await post('/chat/send', { content, from, contact_name, sent_by_user: 0, unique_identifier });
    return response;
  } catch (error) {
